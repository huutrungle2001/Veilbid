...
import moduleArtifact from "../artifacts/contracts/SafePreparationSpike.sol/SafePreparationModuleSpike.json" with {
  type: "json",
};
import consumerArtifact from "../artifacts/contracts/SafePreparationSpike.sol/SafeFundingConsumerSpike.json" with {
  type: "json",
};
