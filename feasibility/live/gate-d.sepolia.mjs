...
import underlyingArtifact from "../artifacts/contracts/EscrowSettlementSpikes.sol/TestUSDC.json" with {
  type: "json",
};
import wrapperArtifact from "../artifacts/contracts/EscrowSettlementSpikes.sol/TestConfidentialUSDC.json" with {
  type: "json",
};
import singleArtifact from "../artifacts/contracts/EscrowSettlementSpikes.sol/SingleEscrowSettlementSpike.json" with {
  type: "json",
};
import splitEscrowArtifact from "../artifacts/contracts/EscrowSettlementSpikes.sol/SplitEscrowSpike.json" with {
  type: "json",
};
import splitMarketArtifact from "../artifacts/contracts/EscrowSettlementSpikes.sol/SplitMarketSettlementSpike.json" with {
  type: "json",
};
