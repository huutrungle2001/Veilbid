...
| Frontend unit | Wallet, forms, roles, URL state, pending/recovery | PARTIAL — 35 tests cover wallet/session clearing, Buyer/Vendor validation, standalone routes, public dossiers, recovery, Auditor ACL-before-decrypt, and preparation-only Safe term binding; fresh-wallet live browser writes/reveal remain pending |
