...
| Secret scan | Repository and evidence clean | PASS — 208 tracked files, 549 historical blobs, and 28 sanitized evidence files pass credential-pattern, forbidden-field, local-environment, and Git-history checks |
