...
| 2026-07-27 | Automatic review frontend release | `208e810` | `evidence/sepolia/production-smoke.json`, `evidence/sepolia/production-keyboard.json` | PASS — Vercel deployment `dpl_DgfAxLWdc4cfVzhtVntjEn4g4uHj` served the four primary workspaces and advanced EOA fallback against Market `0x720a…8afc`; canonical routes, wallet-free awarded tender #1, desktop/mobile rendering, keyboard traversal, sticky layouts, and 195 Docs contrast checks passed |
| 2026-07-27 | First-class EOA Buyer restoration | `4cd8d3d` | `evidence/sepolia/production-smoke.json`, `evidence/sepolia/production-keyboard.json` | PASS — Vercel deployment `dpl_8b9MuiqWoBb7cWt5aRU1K1ohfXAS` restored EOA Buyer to the primary workspace bar while retaining Safe Buyer and automatic review; all routes, Market `0x720a…8afc`, awarded tender #1, desktop/mobile rendering, keyboard traversal, sticky layouts, and 195 Docs contrast checks passed |
