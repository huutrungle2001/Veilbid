...
Run `pnpm bindings:generate` at the repository root after compiling the VeilBid
Market workspace. `pnpm bindings:check` fails when committed JSON differs from
